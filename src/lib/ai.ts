...
const DEFAULT_SYSTEM_PROMPT =
  ...
  "conversational — WhatsApp messages should rarely exceed 3 sentences. " +
  "Plain text only: no markdown headings, tables or code fences.";
 ...
 * `history` must be in chronological order and already include the incoming
 * user message as its last entry.
 */
